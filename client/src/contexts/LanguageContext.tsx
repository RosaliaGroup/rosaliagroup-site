...
const EXTRA_TRANSLATIONS: Record<string, SiteTranslations> = {
  ...
  tl: {
    ...
    footer: { tagline: "Ang iyong mapagkakatiwalaang kasosyo sa real estate sa NJ, NY, at sa buong mundo.", services: "Mga Serbisyo", areas: "Mga Lugar na Pinaglilingkuran", connect: "Kumonekta", rights: "Lahat ng karapatan ay nakalaan.", privacy: "Patakaran sa Privacy", terms: "Mga Tuntunin ng Serbisyo" },
